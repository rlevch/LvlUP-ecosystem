...
- 🆕 Тарифные планы для школ (Стартовый бесплатный)

### Фаза 2 — Монетизация школ + Маркетплейс (2–3 месяца)
**Цель:** запуск levelup-platform.ru (маркетплейс коучей) + расширение возможностей школ на levelup-academy.ru.

- 🆕 ЮKassa Split Payments: расщепление платежей школа↔платформа
...
**Цель:** запуск levelup-association.ru + продвинутые фичи школ на levelup-academy.ru.
